...
class LinkSelectionWidget(QFrame):
    def __init__(self, parent=None):
        ...
        self.titleLabel = SubtitleLabel(self.tr("选择访问的页面"), self)
        ...
        self.btn3 = PushButton("cyrene.cq.cn", self)
        self.btn3.clicked.connect(lambda: QDesktopServices.openUrl(QUrl("https://cyrene.cq.cn")))
        ...
        self.closeBtn = PushButton(self.tr("关闭"), self)
...
class AboutInterface(QWidget):
    ...
    def initUI(self):
        ...
        self.infoContainer.setAttribute(Qt.WidgetAttribute.WA_TransparentForMouseEvents, False)
        ...
        # Title
        self.titleLabel = SubtitleLabel(self.tr('Cyrene QwenTTS GUI'), self)
        self.infoLayout.addWidget(self.titleLabel)
        
        self.versionLabel = BodyLabel(self.tr('版本 0.1.0'), self)
        self.infoLayout.addWidget(self.versionLabel)
        
        self.infoLayout.addSpacing(10)
        
        self.devLabel = StrongBodyLabel(self.tr('开发者: Cyrene2008'), self)
        ...
        self.githubBtn.setStyleSheet("HyperlinkButton { font-weight: bold; color: #FF69B4; }") 
        ...
        self.websiteBtn = PushButton(self.tr('访问我的网站'), self)
        ...
        self.artLabel = BodyLabel(self.tr('美术资源: (C) miHoYo'), self)
        self.infoLayout.addWidget(self.artLabel)
        
        self.licenseLabel = BodyLabel(self.tr('许可证: GPLv3 (附带额外条款)'), self)
        self.infoLayout.addWidget(self.licenseLabel)
        
        self.copyLabel = BodyLabel(self.tr('版权所有 (C) 2026 Cyrene2008'), self)
